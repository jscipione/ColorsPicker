...
#define COLOR_FIELD_SIZE 259.0
#define COLOR_FIELD_RECT BRect(0.0, 0.0, COLOR_FIELD_SIZE, COLOR_FIELD_SIZE)
	...
	fUpdatePort(0)
{
	...
	SetExplicitSize(BSize(COLOR_FIELD_SIZE, COLOR_FIELD_SIZE));
